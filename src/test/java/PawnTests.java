...
public class PawnTests {
	 @Test public void pawnShouldMoveTwoFirstTime () {
	 ...
	 @Test public void pawnShouldMoveOneSpotForward () {
		  Board testBoard = new Board();
		  Assert.assertTrue("Pawn should move two spots on first move",
			  testBoard.move(testBoard.getSpot(0, 1), testBoard.getSpot(0, 2)));
	 }

	 @Test public void pawnShouldNotMoveTwoAfterFirstMove () {
		  Board testBoard = new Board();
		  testBoard.move(testBoard.getSpot(0, 1), testBoard.getSpot(0, 2));
	 ...
	 @Test public void whitePawnShouldNotMoveBackwards () {
		  Board testBoard = new Board();
		  testBoard.move(testBoard.getSpot(0, 1), testBoard.getSpot(0, 2));
	 ...
	 @Test public void blackPawnShouldNotMoveBackwards () {
		  Board testBoard = new Board();
